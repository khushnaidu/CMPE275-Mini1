...
// compares all parallelization strategies
// 1. serial - baseline (no parallelization)
// 2. openmp - data parallelism with pragma omp parallel for
// 3. leader-worker centralized queue - dynamic load balancing
// 4. leader-worker round robin - static task distribution
